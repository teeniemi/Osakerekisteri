 ...
 * @version 2021.05.06 18:08:24 // Generated by ComTest
 *
 */
...
public class OsakerekisteriTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testDeleteTransaction368 
   * @throws Exception when error
   */
  @Test
  public void testDeleteTransaction368() throws Exception {    // Osakerekisteri: 368
    alustaOsakerekisteri(); 
    assertEquals("From: Osakerekisteri line: 371", 2, osakerekisteri.giveTransactions(stock1).size()); 
    osakerekisteri.deleteTransaction(trans11); 
    assertEquals("From: Osakerekisteri line: 373", 1, osakerekisteri.giveTransactions(stock1).size()); 
  } // Generated by ComTest END
}