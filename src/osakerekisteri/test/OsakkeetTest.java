 ...
 * @version 2021.05.07 16:54:32 // Generated by ComTest
 *
 */
...
public class OsakkeetTest {
  ...
  public void testDelete417() throws StoreException {    // Osakkeet: 417
    ...
    assertEquals("From: Osakkeet line: 431", 1, stocks.delete(3)); assertEquals("From: Osakkeet line: 431", 2, stocks.getAmount()); 
    assertEquals("From: Osakkeet line: 432", null, stocks.giveId(2)); 
    assertEquals("From: Osakkeet line: 433", null, stocks.giveId(3)); 
    assertEquals("From: Osakkeet line: 434", trans21, stocks.giveId(1)); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testSearchId453() throws StoreException {    // Osakkeet: 453
    Osakkeet stocks = new Osakkeet(); 
    ...
    assertEquals("From: Osakkeet line: 460", 1, stocks.searchId(id1+1)); 
    assertEquals("From: Osakkeet line: 461", 2, stocks.searchId(id1+2)); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testGiveId473() throws StoreException {    // Osakkeet: 473
    Osakkeet stocks = new Osakkeet(); 
    Osake aku1 = new Osake(), aku2 = new Osake(), aku3 = new Osake(); 
    aku1.register(); aku2.register(); aku3.register(); 
    int id1 = aku1.getId(); 
    stocks.add(aku1); stocks.add(aku2); stocks.add(aku3); 
    assertEquals("From: Osakkeet line: 480", true, stocks.giveId(id1  ) == aku1); 
    assertEquals("From: Osakkeet line: 481", true, stocks.giveId(id1+1) == aku2); 
    assertEquals("From: Osakkeet line: 482", true, stocks.giveId(id1+2) == aku3); 
  } // Generated by ComTest END
}